using GumballMachineWithFilling.State;
using GumballMachineWithFilling.State.Impl;
using System.Text;
...
namespace GumballMachineWithFilling
{
    public class GumballMachine : IGumballMachine
    {
        ...
        public void InsertBalls(uint count)
        {
            _state.AddBalls(count);
        }
        ...
        void IGumballMachine.AddBalls(uint count)
        {
            _count += count;
        }
